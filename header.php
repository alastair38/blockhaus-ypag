...
<div id="page-blockhaus" class="h-full flex flex-col">
	...
	<header id="masthead" class="bg-neutral-light-100 fixed top-0 left-0 right-0 z-50 p-2 lg:relative lg:bg-transparent flex justify-between lg:p-6 items-center">
		...
		<nav id="site-navigation" class="main-navigation flex gap-0 lg:gap-6 items-center lg:shadow-md py-2 h-10 lg:bg-neutral-light-100 lg:px-6 overflow-hidden lg:border-gray-400 lg:rounded-full">
		
			<button class="menu-toggle text-sm flex items-center gap-1 font-sans lg:hidden font-bold uppercase bg-primary-default px-2 shadow-md rounded-full" aria-controls="primary-menu" aria-expanded="false"><span id="mobile-menu-text"><?php esc_html_e( 'Menu', 'blockhaus' ); ?></span><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
